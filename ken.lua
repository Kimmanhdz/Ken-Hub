...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>KEN GAMING  chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "KEN GAMING ", HidePremium = false, IntroText = "KEN GAMING ⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("KEN GAMING  SCRIPT")
W:AddLabel("DiscordKEN GAMING ")
local Section = W:AddSection({
    Name = "Status"
})
